(function (root, factory) {
    ...
    var SmartView = View.extend({
        ...
        constructor: function (options) {
            ...
            // getting the options to pick
            // TODO: throw an error if the options[property] is not a function or it is already exists on the context/prototype
            _.extend(this, _.pick.call(_, options, this.options));
